...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        List<LoopGridViewItem2> mItemList = new List<LoopGridViewItem2>();
        ...
        System.Func<LoopListView2, int, LoopGridViewItem2> mOnGetItemByIndex;
        ...
        public System.Action<LoopListView2,LoopGridViewItem2> mOnSnapItemFinished = null;
        public System.Action<LoopListView2, LoopGridViewItem2> mOnSnapNearestChanged = null;
        ...
        public List<LoopGridViewItem2> ItemList
        {
            get
            {
                return mItemList;
        ...
        */
        public void InitListView(int itemTotalCount,
            System.Func<LoopListView2, int, LoopGridViewItem2> onGetItemByIndex,
        ...
        */
        ...
        public LoopGridViewItem2 GetShownItemByItemIndex(int itemIndex)
        {
        ...
        public LoopGridViewItem2 GetShownItemByItemId(int itemId)
        {
            int count = mItemList.Count;
            if (count == 0)
            {
            ...
            foreach (LoopGridViewItem2 item in mItemList)
            {
        ...
        public LoopGridViewItem2 GetShownItemNearestItemIndex(int itemIndex)
        {
            int count = mItemList.Count;
            if (count == 0)
            {
        ...
        */
        public LoopGridViewItem2 GetShownItemByIndex(int index)
        {
            int count = mItemList.Count;
        ...
        public void SetShownItemByIndex(int index, LoopGridViewItem2 item)
        {
            int count = mItemList.Count;
            if (index < 0 || index >= count)
            {
            ...
            LoopGridViewItem2 cur = mItemList[index];
        ...
        public LoopGridViewItem2 GetShownItemByIndexWithoutCheck(int index)
        {
            return mItemList[index];
        }

        public int GetIndexInShownItemList(LoopGridViewItem2 item)
        {
            if(item == null)
            {
                return -1;
        ...
        public void DoActionForEachShownItem(System.Action<LoopGridViewItem2,object> action,object param)
        {
            if(action == null)
            {
                return;
        ...
        public LoopGridViewItem2 NewListViewItem(string itemPrefabName)
        {
            ItemPool pool = null;
            ...
            LoopGridViewItem2 item = pool.GetItem(mCurCreatingItemIndex);
        ...
        */
        ...
        {
            LoopGridViewItem2 item = GetShownItemByItemIndex(itemIndex);
            if (item == null)
            {
                return;
            }
        ...
        */
        public void RefreshItemByItemIndex(int itemIndex)
        {
            ...
            LoopGridViewItem2 curItem = mItemList[i];
            Vector3 pos = curItem.CachedRectTransform.anchoredPosition3D;
            RecycleItemTmp(curItem);
            LoopGridViewItem2 newItem = GetNewItemByIndex(itemIndex);
            if (newItem == null)
            {
       ...
       */
        ...
        public ItemPosStruct GetFirstShownItemIndexAndOffset()
        {
            ...
            if (ArrangeType == ListItemArrangeType.TopToBottom)
            {
                ...
                LoopGridViewItem2 item = mItemList[0];
        ...
        public void RefreshAllShownItemWithFirstIndex(int firstItemIndex)
        {
            ...
            LoopGridViewItem2 firstItem = mItemList[0];
            Vector3 pos = firstItem.CachedRectTransform.anchoredPosition3D;
            RecycleAllItem();
            for (int i = 0; i < count; ++i)
            {
                int curIndex = firstItemIndex + i;
                LoopGridViewItem2 newItem = GetNewItemByIndex(curIndex);
                if (newItem == null)
                {
                    break;
                }
        ...
        {
            RecycleAllItem();
            LoopGridViewItem2 newItem = GetNewItemByIndex(firstItemIndex);
            if (newItem == null)
            {
                return;
            }
        ...
        public void RecycleItemImmediately(LoopGridViewItem2 item)
        {
            if (item == null)
            {
                return;
        ...
        void RecycleItemTmp(LoopGridViewItem2 item)
        {
            if (item == null)
            {
                return;
        ...
        void InitItemPool()
        {
            foreach (ItemPrefabConfData data in mItemPrefabDataList)
            {
                ...
                AdjustAnchor(rtf);
                AdjustPivot(rtf);
                LoopGridViewItem2 tItem = data.mItemPrefab.GetComponent<LoopGridViewItem2>();
                if (tItem == null)
                {
                    data.mItemPrefab.AddComponent<LoopGridViewItem2>();
                }
        ...
        LoopGridViewItem2 GetNewItemByIndex(int index)
        {
            ...
            LoopGridViewItem2 newItem = mOnGetItemByIndex(this, index);
            if (newItem == null)
            {
                return null;
            }
        ...
        public Vector3 GetItemCornerPosInViewPort(LoopGridViewItem2 item, ItemCornerEnum corner = ItemCornerEnum.LeftBottom)
        {
        ...
        void AdjustPanelPos()
        {
            ...
            if (mArrangeType == ListItemArrangeType.TopToBottom)
            {
                ...
                LoopGridViewItem2 tViewItem0 = mItemList[0];
                ...
                LoopGridViewItem2 tViewItem1 = mItemList[mItemList.Count - 1];
        ...
        void UpdateSnapVertical(bool immediate = false, bool forceSendEvent = false)
        {
            ...
            if (immediate || Mathf.Abs(mCurSnapData.mTargetSnapVal - mCurSnapData.mCurSnapVal) < mSnapFinishThreshold)
            {
                ...
                {
                    LoopGridViewItem2 targetItem = GetShownItemByItemIndex(mCurSnapNearestItemIndex);
                    if(targetItem != null)
                    {
        ...
        void UpdateCurSnapData()
        {
            ...
            if (mCurSnapData.mSnapStatus == SnapStatus.SnapMoving)
            {
                if(mCurSnapData.mIsForceSnapTo)
                {
                    ...
                    {
                        LoopGridViewItem2 targetItem = GetShownItemNearestItemIndex(mCurSnapData.mSnapTargetIndex);
                        if (targetItem == null)
                        {
                            mCurSnapData.Clear();
                            return;
            ...
            {
                LoopGridViewItem2 nearestItem = GetShownItemByItemIndex(mCurSnapNearestItemIndex);
                if (nearestItem == null)
                {
                    return;
                }
        ...
        bool UpdateForVertList(float distanceForRecycle0,float distanceForRecycle1,float distanceForNew0, float distanceForNew1)
        {
            ...
            if (mArrangeType == ListItemArrangeType.TopToBottom)
            {
                ...
                if (itemListCount == 0)
                {
                    ...
                    LoopGridViewItem2 newItem = GetNewItemByIndex(index);
                    if (newItem == null)
                    {
                        return false;
                    }
                ...
                if (mViewPortRectLocalCorners[0].y - downPos1.y < distanceForNew1)
                {
                    ...
                    {
                        LoopGridViewItem2 newItem = GetNewItemByIndex(nIndex);
                        if (newItem == null)
                        {
                            mCurReadyMaxItemIndex = tViewItem1.ItemIndex;
                            mNeedCheckNextMaxItem = false;
        ...
        void CheckIfNeedUpdataItemPos()
        {
            ...
            {
                LoopGridViewItem2 firstItem = mItemList[0];
                LoopGridViewItem2 lastItem = mItemList[mItemList.Count - 1];
        ...
        void UpdateAllShownItemsPos()
        {
            ...
            if (mArrangeType == ListItemArrangeType.TopToBottom)
            {
                ...
                for (int i = 0; i < count; ++i)
                {
                    LoopGridViewItem2 item = mItemList[i];
