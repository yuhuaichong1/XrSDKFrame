...
namespace SuperScrollView
{
    public class ItemPool
    {
        ...
        List<LoopGridViewItem2> mTmpPooledItemList = new List<LoopGridViewItem2>();
        List<LoopGridViewItem2> mPooledItemList = new List<LoopGridViewItem2>();
        ...
        public void Init(GameObject prefabObj, float padding, float startPosOffset, int createCount, RectTransform parent)
        {
            ...
            {
                LoopGridViewItem2 tViewItem = CreateItem();
                RecycleItemReal(tViewItem);
            }
        }
        public LoopGridViewItem2 GetItem(int itemIndexForSearch)
        {
            mCurItemIdCount++;
            LoopGridViewItem2 tItem = null;
        ...
        public LoopGridViewItem2 CreateItem()
        {
            ...
            LoopGridViewItem2 tViewItem = go.GetComponent<LoopGridViewItem2>();
            tViewItem.ItemPrefabName = mPrefabName;
            tViewItem.StartPosOffset = mStartPosOffset;
            return tViewItem;
        }
        public void RecycleItemReal(LoopGridViewItem2 item)
        {
            item.gameObject.SetActive(false);
            mPooledItemList.Add(item);
        }
        public void RecycleItem(LoopGridViewItem2 item)
        {
