...
namespace XrCode
{
    public class GameObjectManager : MonoSingleton<GameObjectManager>, ILoad
    {
        /// <summary>
        /// 资源路径 -> UnityObjectPool
        /// </summary>
        private Dictionary<string, GameObjectPool> mPoolDict;

        public void Load()
        {
            mPoolDict = new Dictionary<string, GameObjectPool>();
        }
