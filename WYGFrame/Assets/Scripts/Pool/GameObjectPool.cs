...
namespace XrCode
{
    public class GameObjectPool
    {
        ...
        public GameObject SyncSpawn()
        {
            ...
            {
                NoRecycleCount++;
                var orginal = ResourceMod.Instance.SyncLoad<GameObject>(mPath);
        ...
        public void AsyncSpawn(System.Action<GameObject> callback)
        {
            ...
            {
                ResourceMod.Instance.AsyncLoad<GameObject>(mPath, (orginal) =>
                {
                    NoRecycleCount++;
        ...
        public void Dispose()
        {
            ...
            mPool.Clear();
            ResourceMod.Instance.Unload(mPath, false, NoRecycleCount + mPool.Count);
        }
    }
}