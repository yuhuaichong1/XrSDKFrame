...
namespace XrCode
{
    public class FileUtil
    {
        ...
        public static bool WriteAllText(string outFile, string outText)
        {
            ...
            {
                D.Error("WriteAllText failed! path = {0} with err = {1}", outFile, e.Message);
                return false;
            }
        }
        ...
        public static bool WriteAllBytes(string outFile, byte[] outBytes)
        {
            ...
            {
                D.Error("WriteAllBytes failed! path = {0} with err = {1}", outFile, e.Message);
                return false;
            }
        }
        ...
        public static string ReadAllText(string inFile)
        {
            ...
            {
                D.Error("ReadAllText failed! path = {0} with err = {1}", inFile, e.Message);
                return null;
            }
        }
        ...
        public static byte[] ReadAllBytes(string inFile)
        {
            ...
            {
                D.Error("ReadAllBytes failed! path = {0} with err = {1}", inFile, e.Message);
                return null;
            }
        }
